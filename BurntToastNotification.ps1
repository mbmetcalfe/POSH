#requires -Version 2 
function BurntToastNotification
{
    <# 
        .SYNOPSIS 
        ...
        .DESCRIPTION 
        The BurntToastNotification cmdlet creates and displays a Toast Notification on Microsoft Windows 8 and Windows 10 operating systems. 
        ...
        You can optionally call the BurntToastNotification cmdlet with the Toast alias. 
        ...
        BurntToastNotification displays the Toast Notification that is created. 
         
        .NOTES 
 
        Assume that you have logged into Windows as Example\User01 and have run a PowerShell host as Example\Admin01. 
 
        When you run the BurntToastNotification cmdlet a toast would attempt to be displayed using Admin01's notification manager but this does not exist. 
        ...
        .EXAMPLE 
        BurntToastNotification -FirstLine 'Example Script' -SecondLine 'The example script has run successfully.' 
         
        This command creates and displays a Toast Notification with customized title and display text, but with the default image. 
 
        .EXAMPLE 
        BurntToastNotification -Template 'ToastText01' -FirstLine 'The example script has run successfully. This toast has no title.' 
 
        This command creates and displays a Toast Notification using an imageless template and no embolden title. 
 
        .EXAMPLE 
        BurntToastNotification -FirstLine 'WAKE UP!' -Sound 'Alarm2' 
        ...
        .EXAMPLE 
        $cred = Get-Credential 
        PS C:\>BurntToastNotification -FirstLine 'Admin Example Script' -SecondLine 'The administrative example script has run successfully.' -Credential $cred 
 
        This example prompts for a username and password and supplies the resulting object to the BurntToastNotification. 
        ...
        if (Test-PSDifferentUser)
        {
            if ($PSBoundParameters.ContainsKey('credential'))
            {
                $ToasterJob = Start-Job -Credential $Credential -ScriptBlock {
                    ...
                    BurntToastNotification @BoundParameters
